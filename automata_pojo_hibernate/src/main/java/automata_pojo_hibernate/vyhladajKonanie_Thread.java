...
import automata_pojo_hibernate.kafkaThreadConsumer.ConsumerRunnable;

public class vyhladajKonanie_Thread {

	public static void main(String[] args) {
		System.out.println("vyhladajKonanie_Thread");

        new vyhladajKonanie_Thread().run();

	}
	private vyhladajKonanie_Thread(){
