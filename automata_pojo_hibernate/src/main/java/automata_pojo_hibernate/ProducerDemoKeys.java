...
public class ProducerDemoKeys {
	...
	public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        SQLQuery query = session.createSQLQuery("select distinct a.request_id FROM soapdemo.Request a left join soapdemo.Request_Items b on a.request_id = b.request_id where b.request_id is null");
		...
		for(int c1=0; c1 < values.length; c1++) {
			...
			String topic = "integration_start";
			//String value = Integer.toString(c1);
			String value = values[c1];
