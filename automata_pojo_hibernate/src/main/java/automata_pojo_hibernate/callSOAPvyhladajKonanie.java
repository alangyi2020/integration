...
public class callSOAPvyhladajKonanie {
	 ...
	 @Autowired
	  ...
	  /*  @PostConstruct
	    ...
	    public String do_callSOAPvyhladajKonanie(int request_id, int provider_id) throws SQLException, Exception {
		PojoFactory factory = PojoFactory.getInstance();
		try {
			int CSRU_Service_id = provider_id;
			...
			List<Request> requests = factory.getRequestsbyProvider(request_id,provider_id);
